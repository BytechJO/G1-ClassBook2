          ...
          <div className="container12" ref={containerRef}>
            ...
            <div className="matching-row2">
              <div className="word-with-dot2">
                ...
                {wrongWords.includes("I can fly a kite.") && (
              ...
              <div className="word-with-dot2">
                ...
                <div className="dot-wrapper2">
                  <div
                    className="dot2 start-dot2"
                    id="dot-tiger"
                    data-word="He can’t sail a boat."
                    onClick={handleStartDotClick}
                  ></div>
                </div>
              </div>
              ...
              <div className="word-with-dot2">
                ...
                <div className="dot-wrapper2">
                  <div
                    className="dot2 start-dot2"
                    id="dot-dish"
                    data-word="It can’t climb a tree."
                    onClick={handleStartDotClick}
                  ></div>
                </div>
              </div>
              ...
              <div className="word-with-dot2">
                ...
                <div className="dot-wrapper2">
                  <div
                    className="dot2 start-dot2"
                    id="dot-paint"
                    data-word="He can paint a picture."
                    onClick={handleStartDotClick}
                  ></div>
                </div>
              </div>
