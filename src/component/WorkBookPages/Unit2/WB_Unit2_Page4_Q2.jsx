...
const WB_Unit2_Page4_Q2 = () => {
  ...
  const correctMatches = [
    { word: "Happy birthday!", image: "img1" },
    { word: "It’s jello.", image: "img2" },
    { word: "It’s a present.", image: "img3" },
    { word: "It’s a birthday cake.", image: "img4" },
  ];
          ...
          <div className="container12" ref={containerRef}>
            ...
            <div className="matching-row2">
              <div className="img-with-dot2">
                ...
                />
                {wrongWords.includes("Happy birthday!") && ( // ⭐ تم التعديل هون
            ...
            <div className="matching-row2">
              <div className="img-with-dot2">
                ...
                <img
                  ...
                  style={{ height: "auto", width: "120px", cursor: "pointer" }}
                />
                {wrongWords.includes("It’s jello.") && ( // ⭐ تم التعديل هون
                  <span className="error-mark8-wb-unit2-p4-q2">✕</span>
                )}{" "}
                <div className="dot-wrapper2">
                  <div
              ...
              <div className="word-with-dot2">
                <div className="dot-wrapper2">
                  <div
                    className="dot2 end-dot2"
                    data-word="It’s a birthday cake."
                    id="dot-pizza"
                    onClick={handleEndDotClick}
                  ></div>
                </div>
            ...
            <div className="matching-row2">
              <div className="img-with-dot2">
                ...
                <img
                  ...
                  style={{ height: "auto", width: "120px", cursor: "pointer" }}
                />
                {wrongWords.includes("It’s a present.") && ( // ⭐ تم التعديل هون
                  <span className="error-mark8-wb-unit2-p4-q2">✕</span>
                )}{" "}
                <div className="dot-wrapper2">
                  <div
            ...
            <div className="matching-row2">
              <div className="img-with-dot2">
                ...
                <img
                  ...
                  style={{ height: "auto", width: "120px", cursor: "pointer" }}
                />
                {wrongWords.includes("It’s a birthday cake.") && ( // ⭐ تم التعديل هون
                  <span className="error-mark8-wb-unit2-p4-q2">✕</span>
                )}{" "}
                <div className="dot-wrapper2">
                  <div
